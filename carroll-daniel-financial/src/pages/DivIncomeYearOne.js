...
class DivIncomeYearOne extends Component{
...
if(value === 'project_report'){
      ...
      //if(checkCompleted === 1){
          ...
          for (var kj=0; kj < global.burnOffChart.length; kj++) {
            if(kj >= CurrentMonthOfProject){
                ...
                //console.log("Job Name: " + job_name + " Backlog: " + backlogFuture + " Value: " + valueFoundProjected + " BurnoffSum: " + burnOffSum)
                //console.log("Job Name: " + job_name + " Monthly Value: " + monthlyValueProjected + " Value Found: " + valueFoundProjected + " BurnoffSum: " + burnOffSum)
          ...
          for (var pj=0; pj < global.burnOffChart.length; pj++) {
            if(pj >= CurrentMonthOfProjectPast){
                ...
                if(checkloopProjectedPrevious <= forecastNumberProjectedPrevious){
                    //console.log("Job Name: " + job_name + " Status: " + status + " Total Revenue: " + monthlyValueProjectedPast + " Forecast Num: " + forecastNumberProjectedPrevious);
  ...
  revenueFinalTotal = parseFloat(expectedRevenue1) + parseFloat(expectedRevenueABNC1) + parseFloat(expectedRevenueFA1) + parseFloat(expectedRevenue2) + parseFloat(expectedRevenueABNC2) + parseFloat(expectedRevenueFA2) + parseFloat(expectedRevenue3) + parseFloat(expectedRevenueABNC3) + parseFloat(expectedRevenueFA3) + parseFloat(expectedRevenue4) + parseFloat(expectedRevenueABNC4) + parseFloat(expectedRevenueFA4) + parseFloat(expectedRevenue5) + parseFloat(expectedRevenueABNC5) + parseFloat(expectedRevenueFA5) + parseFloat(expectedRevenue6) + parseFloat(expectedRevenueABNC6) + parseFloat(expectedRevenueFA6) + parseFloat(expectedRevenue7) + parseFloat(expectedRevenueABNC7) + parseFloat(expectedRevenueFA7) + parseFloat(expectedRevenue11) + parseFloat(expectedRevenueABNC11) + parseFloat(expectedRevenueFA11) +  parseFloat(expectedRevenue00) + parseFloat(expectedRevenueABNC00) + parseFloat(expectedRevenueFA00);
...
this.state.OverHeadData.map((OverHeadData, index) => {
  ...
  if(account >= 5020 && account <= 6999 && department === "01"){
    if(account >= 5020 && account <= 6999 && department === "01" && status === "Actual"){
      //console.log("currentMonth: " + currentMonth + " quarter: " + currentQuarterResp + " year: " + currentYearResp)
        if(currentMonth === 3){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
 ...
 renderTableHeader(value) {
  ...
  return <>
    ...
    return <>
        ...
        <th style={{ textAlign: 'center'}}>Total</th>
            ...
            <th style={{ textAlign: 'center'}}>{'$' + (((Math.round(expectedProfit00) + Math.round(expectedProfitABNC00) + Math.round(expectedProfitFA00))) + ma_profit_00).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + (((Math.round(preexpectedProfit00) + Math.round(preexpectedProfitABNC00) + Math.round(preexpectedProfitFA00))) + prev_ma_profit_00).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
  ...
  return <>
        ...
        <th style={{ textAlign: 'center'}}>Total G & A Cost</th>
            ...
            <th style={{ textAlign: 'center'}}>{}</th>
            <th style={{ textAlign: 'center'}}>{}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
        </tr>
        <tr>
        <th style={{ textAlign: 'center'}}>Direct Overhead Expenses</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divOneOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivOneOverhead).toLocaleString(undefined, {maximumFractionDigits: 2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divTwoOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivTwoOverhead).toLocaleString(undefined, {maximumFractionDigits: 2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divThreeOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivThreeOverhead).toLocaleString(undefined, {maximumFractionDigits: 2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divFourOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivFourOverhead).toLocaleString(undefined, {maximumFractionDigits: 2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divFiveOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivFiveOverhead).toLocaleString(undefined, {maximumFractionDigits: 2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divSixOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivSixOverhead).toLocaleString(undefined, {maximumFractionDigits: 2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divSevenOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivSevenOverhead).toLocaleString(undefined, {maximumFractionDigits: 2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divElevenOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivElevenOverhead).toLocaleString(undefined, {maximumFractionDigits: 2})}</th>
            <th style={{ textAlign: 'center'}}>{'($' + Math.round(divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead).toLocaleString(undefined, {maximumFractionDigits:2}) + ')'}</th>
            <th style={{ textAlign: 'center'}}>{'($' + Math.round(predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead).toLocaleString(undefined, {maximumFractionDigits:2}) + ')'}</th> 
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead))}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead))}</th> 
        </tr>
        <tr>
        <th style={{ textAlign: 'center'}}>50% of Rev. Allocation</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(revenueFinalTotal ? ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue1 + expectedRevenueABNC1 + expectedRevenueFA1) / revenueFinalTotal)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue1 + preexpectedRevenueABNC1 + preexpectedRevenueFA1) / prerevenueFinalTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(revenueFinalTotal ? ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue2 + expectedRevenueABNC2 + expectedRevenueFA2) / revenueFinalTotal)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue2 + preexpectedRevenueABNC2 + preexpectedRevenueFA2) / prerevenueFinalTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(revenueFinalTotal ? ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue3 + expectedRevenueABNC3 + expectedRevenueFA3) / revenueFinalTotal)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue3 + preexpectedRevenueABNC3 + preexpectedRevenueFA3) / prerevenueFinalTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(revenueFinalTotal ? ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue4 + expectedRevenueABNC4 + expectedRevenueFA4) / revenueFinalTotal)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue4 + preexpectedRevenueABNC4 + preexpectedRevenueFA4) / prerevenueFinalTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(revenueFinalTotal ? ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue5 + expectedRevenueABNC5 + expectedRevenueFA5) / revenueFinalTotal)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue5 + preexpectedRevenueABNC5 + preexpectedRevenueFA5) / prerevenueFinalTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(revenueFinalTotal ? ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue6 + expectedRevenueABNC6 + expectedRevenueFA6) / revenueFinalTotal)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue6 + preexpectedRevenueABNC6 + preexpectedRevenueFA6) / prerevenueFinalTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(revenueFinalTotal ? ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue7 + expectedRevenueABNC7 + expectedRevenueFA7) / revenueFinalTotal)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue7 + preexpectedRevenueABNC7 + preexpectedRevenueFA7) / prerevenueFinalTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(revenueFinalTotal ? ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue11 + expectedRevenueABNC11 + expectedRevenueFA11) / revenueFinalTotal)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue11 + preexpectedRevenueABNC11 + preexpectedRevenueFA11) / prerevenueFinalTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
        ...
        <th style={{ textAlign: 'center'}}>50% of GM Allocation</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) ? (((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit1 + expectedProfitABNC1 + expectedProfitFA1) / profitSummary) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) ? Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2)  * ((preexpectedProfit1 + preexpectedProfitABNC1 + preexpectedProfitFA1) / preprofitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) ? (((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit2 + expectedProfitABNC2 + expectedProfitFA2) / profitSummary) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) ? Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit2 + preexpectedProfitABNC2 + preexpectedProfitFA2) / preprofitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) ? (((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit3 + expectedProfitABNC3 + expectedProfitFA3) / profitSummary) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) ? Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit3 + preexpectedProfitABNC3 + preexpectedProfitFA3) / preprofitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) ? (((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit4 + expectedProfitABNC4 + expectedProfitFA4) / profitSummary) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) ? Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit4 + preexpectedProfitABNC4 + preexpectedProfitFA4) / preprofitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) ? (((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit5 + expectedProfitABNC5 + expectedProfitFA5) / profitSummary) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) ? Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit5 + preexpectedProfitABNC5 + preexpectedProfitFA5) / preprofitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) ? (((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit6 + expectedProfitABNC6 + expectedProfitFA6) / profitSummary) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) ? Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit6 + preexpectedProfitABNC6 + preexpectedProfitFA6) / preprofitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) ? Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit7 + expectedProfitABNC7 + expectedProfitFA7) / profitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) ? Math.round((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit7 + preexpectedProfitABNC7 + preexpectedProfitFA7) / preprofitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) ? Math.round((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit11 + expectedProfitABNC11 + expectedProfitFA11) / profitSummary)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
        ...
        <tr>
        <th style={{ textAlign: 'center'}}>% Rev</th>
            <th style={{ textAlign: 'center'}}>{(((expectedRevenue1 + expectedRevenueABNC1 + expectedRevenueFA1) !== 0 ? ((divOneOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue1 + expectedRevenueABNC1 + expectedRevenueFA1) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit1 + expectedProfitABNC1 + expectedProfitFA1) / profitSummary))) / (expectedRevenue1 + expectedRevenueABNC1 + expectedRevenueFA1)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((preexpectedRevenue1 + preexpectedRevenueABNC1 + preexpectedRevenueFA1) !== 0 ? ((predivOneOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue1 + preexpectedRevenueABNC1 + preexpectedRevenueFA1) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit1 + preexpectedProfitABNC1 + preexpectedProfitFA1) / preprofitSummary))) / (preexpectedRevenue1 + preexpectedRevenueABNC1 + preexpectedRevenueFA1)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((expectedRevenue2 + expectedRevenueABNC2 + expectedRevenueFA2) !== 0 ? ((divTwoOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue2 + expectedRevenueABNC2 + expectedRevenueFA2) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit2 + expectedProfitABNC2 + expectedProfitFA2) / profitSummary))) / (expectedRevenue2 + expectedRevenueABNC2 + expectedRevenueFA2)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((preexpectedRevenue2 + preexpectedRevenueABNC2 + preexpectedRevenueFA2) !== 0 ? ((predivTwoOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue2 + preexpectedRevenueABNC2 + preexpectedRevenueFA2) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit2 + preexpectedProfitABNC2 + preexpectedProfitFA2) / preprofitSummary))) / (preexpectedRevenue2 + preexpectedRevenueABNC2 + preexpectedRevenueFA2)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((expectedRevenue3 + expectedRevenueABNC3 + expectedRevenueFA3) !== 0 ? ((divThreeOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue3 + expectedRevenueABNC3 + expectedRevenueFA3) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit3 + expectedProfitABNC3 + expectedProfitFA3) / profitSummary))) / (expectedRevenue3 + expectedRevenueABNC3 + expectedRevenueFA3)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((preexpectedRevenue3 + preexpectedRevenueABNC3 + preexpectedRevenueFA3) !== 0 ? ((predivThreeOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue3 + preexpectedRevenueABNC3 + preexpectedRevenueFA3) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit3 + preexpectedProfitABNC3 + preexpectedProfitFA3) / preprofitSummary))) / (preexpectedRevenue3 + preexpectedRevenueABNC3 + preexpectedRevenueFA3)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((expectedRevenue4 + expectedRevenueABNC4 + expectedRevenueFA4) !== 0 ? ((divFourOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue4 + expectedRevenueABNC4 + expectedRevenueFA4) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit4 + expectedProfitABNC4 + expectedProfitFA4) / profitSummary))) / (expectedRevenue4 + expectedRevenueABNC4 + expectedRevenueFA4)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((preexpectedRevenue4 + preexpectedRevenueABNC4 + preexpectedRevenueFA4) !== 0 ? ((predivFourOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue4 + preexpectedRevenueABNC4 + preexpectedRevenueFA4) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit4 + preexpectedProfitABNC4 + preexpectedProfitFA4) / preprofitSummary))) / (preexpectedRevenue4 + preexpectedRevenueABNC4 + preexpectedRevenueFA4)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((expectedRevenue5 + expectedRevenueABNC5 + expectedRevenueFA5) !== 0 ? ((divFiveOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue5 + expectedRevenueABNC5 + expectedRevenueFA5) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit5 + expectedProfitABNC5 + expectedProfitFA5) / profitSummary))) / (expectedRevenue5 + expectedRevenueABNC5 + expectedRevenueFA5)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((preexpectedRevenue5 + preexpectedRevenueABNC5 + preexpectedRevenueFA5) !== 0 ? ((predivFiveOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue5 + preexpectedRevenueABNC5 + preexpectedRevenueFA5) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit5 + preexpectedProfitABNC5 + preexpectedProfitFA5) / preprofitSummary))) / (preexpectedRevenue5 + preexpectedRevenueABNC5 + preexpectedRevenueFA5)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((expectedRevenue6 + expectedRevenueABNC6 + expectedRevenueFA6) !== 0 ? ((divSixOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue6 + expectedRevenueABNC6 + expectedRevenueFA6) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit6 + expectedProfitABNC6 + expectedProfitFA6) / profitSummary))) / (expectedRevenue6 + expectedRevenueABNC6 + expectedRevenueFA6)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((preexpectedRevenue6 + preexpectedRevenueABNC6 + preexpectedRevenueFA6) !== 0 ? ((predivSixOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue6 + preexpectedRevenueABNC6 + preexpectedRevenueFA6) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit6 + preexpectedProfitABNC6 + preexpectedProfitFA6) / preprofitSummary))) / (preexpectedRevenue6 + preexpectedRevenueABNC6 + preexpectedRevenueFA6)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((expectedRevenue7 + expectedRevenueABNC7 + expectedRevenueFA7) !== 0 ? ((divSevenOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue7 + expectedRevenueABNC7 + expectedRevenueFA7) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit7 + expectedProfitABNC7 + expectedProfitFA7) / profitSummary))) / (expectedRevenue7 + expectedRevenueABNC7 + expectedRevenueFA7)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((preexpectedRevenue7 + preexpectedRevenueABNC7 + preexpectedRevenueFA7) !== 0 ? ((predivSevenOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue7 + preexpectedRevenueABNC7 + preexpectedRevenueFA7) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit7 + preexpectedProfitABNC7 + preexpectedProfitFA7) / preprofitSummary))) / (preexpectedRevenue7 + preexpectedRevenueABNC7 + preexpectedRevenueFA7)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((expectedRevenue11 + expectedRevenueABNC11 + expectedRevenueFA11) !== 0 ? ((divElevenOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue11 + expectedRevenueABNC11 + expectedRevenueFA11) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit11 + expectedProfitABNC11 + expectedProfitFA11) / profitSummary))) / (expectedRevenue11 + expectedRevenueABNC11 + expectedRevenueFA11)) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{(((preexpectedRevenue11 + preexpectedRevenueABNC11 + preexpectedRevenueFA11) !== 0 ? ((predivElevenOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue11 + preexpectedRevenueABNC11 + preexpectedRevenueFA11) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit11 + preexpectedProfitABNC11 + preexpectedProfitFA11) / preprofitSummary))) / (preexpectedRevenue11 + preexpectedRevenueABNC11 + preexpectedRevenueFA11)) : 0) * 100).toFixed(1) + '%'}</th>
     ...
     <tr>
        ...
        <th style={{ textAlign: 'center'}}>% Rev</th>
            ...
            <th style={{ textAlign: 'center'}}>{((((expectedRevenue4 + expectedRevenueABNC4 + expectedRevenueFA4)) !== 0 ? ((((parseFloat(expectedProfit4) + parseFloat(expectedProfitABNC4) + parseFloat(expectedProfitFA4)) - (divFourOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue4 + expectedRevenueABNC4 + expectedRevenueFA4) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit4 + expectedProfitABNC4 + expectedProfitFA4) / profitSummary))))) / ((expectedRevenue4 + expectedRevenueABNC4 + expectedRevenueFA4))) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{((((preexpectedRevenue4 + preexpectedRevenueABNC4 + preexpectedRevenueFA4)) !== 0 ? ((((parseFloat(preexpectedProfit4) + parseFloat(preexpectedProfitABNC4) + parseFloat(preexpectedProfitFA4)) - (predivFourOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue4 + preexpectedRevenueABNC4 + preexpectedRevenueFA4) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit4 + preexpectedProfitABNC4 + preexpectedProfitFA4) / preprofitSummary))))) / ((preexpectedRevenue4 + preexpectedRevenueABNC4 + preexpectedRevenueFA4))) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{((((expectedRevenue5 + expectedRevenueABNC5 + expectedRevenueFA5)) !== 0 ? ((((parseFloat(expectedProfit5) + parseFloat(expectedProfitABNC5) + parseFloat(expectedProfitFA5)) - (divFiveOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue5 + expectedRevenueABNC5 + expectedRevenueFA5) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit5 + expectedProfitABNC5 + expectedProfitFA5) / profitSummary))))) / ((expectedRevenue5 + expectedRevenueABNC5 + expectedRevenueFA5))) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{((((preexpectedRevenue5 + preexpectedRevenueABNC5 + preexpectedRevenueFA5)) !== 0 ? ((((parseFloat(preexpectedProfit5) + parseFloat(preexpectedProfitABNC5) + parseFloat(preexpectedProfitFA5)) - (predivFiveOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue5 + preexpectedRevenueABNC5 + preexpectedRevenueFA5) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit5 + preexpectedProfitABNC5 + preexpectedProfitFA5) / preprofitSummary))))) / ((preexpectedRevenue5 + preexpectedRevenueABNC5 + preexpectedRevenueFA5))) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{((((expectedRevenue6 + expectedRevenueABNC6 + expectedRevenueFA6)) !== 0 ? ((((parseFloat(expectedProfit6) + parseFloat(expectedProfitABNC6) + parseFloat(expectedProfitFA6)) - (divSixOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue6 + expectedRevenueABNC6 + expectedRevenueFA6) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit6 + expectedProfitABNC6 + expectedProfitFA6) / profitSummary))))) / ((expectedRevenue6 + expectedRevenueABNC6 + expectedRevenueFA6))) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{((((preexpectedRevenue6 + preexpectedRevenueABNC6 + preexpectedRevenueFA6)) !== 0 ? ((((parseFloat(preexpectedProfit6) + parseFloat(preexpectedProfitABNC6) + parseFloat(preexpectedProfitFA6)) - (predivSixOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue6 + preexpectedRevenueABNC6 + preexpectedRevenueFA6) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit6 + preexpectedProfitABNC6 + preexpectedProfitFA6) / preprofitSummary))))) / ((preexpectedRevenue6 + preexpectedRevenueABNC6 + preexpectedRevenueFA6))) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{((((expectedRevenue7 + expectedRevenueABNC7 + expectedRevenueFA7)) !== 0 ? ((((parseFloat(expectedProfit7) + parseFloat(expectedProfitABNC7) + parseFloat(expectedProfitFA7)) - (divSevenOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue7 + expectedRevenueABNC7 + expectedRevenueFA7) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit7 + expectedProfitABNC7 + expectedProfitFA7) / profitSummary))))) / ((expectedRevenue7 + expectedRevenueABNC7 + expectedRevenueFA7))) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{((((preexpectedRevenue7 + preexpectedRevenueABNC7 + preexpectedRevenueFA7)) !== 0 ? ((((parseFloat(preexpectedProfit7) + parseFloat(preexpectedProfitABNC7) + parseFloat(preexpectedProfitFA7)) - (predivSevenOverhead + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedRevenue7 + preexpectedRevenueABNC7 + preexpectedRevenueFA7) / prerevenueFinalTotal)) + ((((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)) / 2) * ((preexpectedProfit7 + preexpectedProfitABNC7 + preexpectedProfitFA7) / preprofitSummary))))) / ((preexpectedRevenue7 + preexpectedRevenueABNC7 + preexpectedRevenueFA7))) : 0) * 100).toFixed(1) + '%'}</th>
            <th style={{ textAlign: 'center'}}>{((((expectedRevenue11 + expectedRevenueABNC11 + expectedRevenueFA11)) !== 0 ? ((((parseFloat(expectedProfit11) + parseFloat(expectedProfitABNC11) + parseFloat(expectedProfitFA11)) - (divElevenOverhead + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedRevenue11 + expectedRevenueABNC11 + expectedRevenueFA11) / revenueFinalTotal)) + ((((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) / 2) * ((expectedProfit11 + expectedProfitABNC11 + expectedProfitFA11) / profitSummary))))) / ((expectedRevenue11 + expectedRevenueABNC11 + expectedRevenueFA11))) : 0) * 100).toFixed(1) + '%'}</th>
        ...
        <th style={{ textAlign: 'center'}}>Deferred Compensation</th>
            ...
            <th style={{ textAlign: 'center'}}>{'$' + 0}</th>
            <th style={{ textAlign: 'center'}}>{'$' + 0}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divDeferrCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivDeferrCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divDeferrCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivDeferrCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
        </tr>
        <tr>
        <th style={{ textAlign: 'center'}}>Profit Sharing</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfOneOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfOneOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfTwoOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfTwoOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfThreeOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfThreeOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfFourOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfFourOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfFiveOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfFiveOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfSixOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfSixOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfSevenOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfSevenOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfElevenOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfElevenOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfZeroOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfZeroOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divProfOneOverhead + divProfTwoOverhead + divProfThreeOverhead + divProfFourOverhead + divProfFiveOverhead + divProfSixOverhead + divProfSevenOverhead + divProfElevenOverhead + divProfZeroOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivProfOneOverhead + predivProfTwoOverhead + predivProfThreeOverhead + predivProfFourOverhead + predivProfFiveOverhead + predivProfSixOverhead + predivProfSevenOverhead + predivProfElevenOverhead + predivProfZeroOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
        </tr>
        <tr>
        <th style={{ textAlign: 'center'}}>Other Income</th>
            ...
            <th style={{ textAlign: 'center'}}>{'$' + 0}</th>
            <th style={{ textAlign: 'center'}}>{'$' + 0}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divInvestCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivInvestCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(divInvestCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(predivInvestCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
        </tr>
        <tr>
        <th style={{ textAlign: 'center'}}>Net Income</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(totalJobProfitOne) - parseFloat(netGACostDiv01) - parseFloat(divProfOneOverhead)) ? (parseFloat(totalJobProfitOne) - parseFloat(netGACostDiv01) - parseFloat(divProfOneOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(pretotalJobProfitOne) - parseFloat(prenetGACostDiv01) - parseFloat(predivProfOneOverhead)) ? (parseFloat(pretotalJobProfitOne) - parseFloat(prenetGACostDiv01) - parseFloat(predivProfOneOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(totalJobProfitTwo) - parseFloat(netGACostDiv02) - parseFloat(divProfTwoOverhead)) ? (parseFloat(totalJobProfitTwo) - parseFloat(netGACostDiv02) - parseFloat(divProfTwoOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(pretotalJobProfitTwo) - parseFloat(prenetGACostDiv02) - parseFloat(predivProfTwoOverhead)) ? (parseFloat(pretotalJobProfitTwo) - parseFloat(prenetGACostDiv02) - parseFloat(predivProfTwoOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(totalJobProfitThree) - parseFloat(netGACostDiv03) - parseFloat(divProfThreeOverhead)) ? (parseFloat(totalJobProfitThree) - parseFloat(netGACostDiv03) - parseFloat(divProfThreeOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(pretotalJobProfitThree) - parseFloat(prenetGACostDiv03)- parseFloat(predivProfThreeOverhead)) ? (parseFloat(pretotalJobProfitThree) - parseFloat(prenetGACostDiv03) - parseFloat(predivProfThreeOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(totalJobProfitFour) - parseFloat(netGACostDiv04) - parseFloat(divProfFourOverhead)) ? (parseFloat(totalJobProfitFour) - parseFloat(netGACostDiv04) - parseFloat(divProfFourOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(pretotalJobProfitFour) - parseFloat(prenetGACostDiv04) - parseFloat(predivProfFourOverhead)) ? (parseFloat(pretotalJobProfitFour) - parseFloat(prenetGACostDiv04) - parseFloat(predivProfFourOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(totalJobProfitFive) - parseFloat(netGACostDiv05) - parseFloat(divProfFiveOverhead)) ? (parseFloat(totalJobProfitFive) - parseFloat(netGACostDiv05) - parseFloat(divProfFiveOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(pretotalJobProfitFive) - parseFloat(prenetGACostDiv05) - parseFloat(predivProfFiveOverhead)) ? (parseFloat(pretotalJobProfitFive) - parseFloat(prenetGACostDiv05) - parseFloat(predivProfFiveOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(totalJobProfitSix) - parseFloat(netGACostDiv06) - parseFloat(divProfSixOverhead)) ? (parseFloat(totalJobProfitSix) - parseFloat(netGACostDiv06) - parseFloat(divProfSixOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(pretotalJobProfitSix) - parseFloat(prenetGACostDiv06) - parseFloat(predivProfSixOverhead)) ? (parseFloat(pretotalJobProfitSix) - parseFloat(prenetGACostDiv06) - parseFloat(predivProfSixOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(totalJobProfitSeven) - parseFloat(netGACostDiv07) - parseFloat(divProfSevenOverhead)) ? (parseFloat(totalJobProfitSeven) - parseFloat(netGACostDiv07) - parseFloat(divProfSevenOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(pretotalJobProfitSeven) - parseFloat(prenetGACostDiv07) - parseFloat(predivProfSevenOverhead)) ? (parseFloat(pretotalJobProfitSeven) - parseFloat(prenetGACostDiv07) - parseFloat(predivProfSevenOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(totalJobProfitEleven) - parseFloat(netGACostDiv11) - parseFloat(divProfElevenOverhead)) ? (parseFloat(totalJobProfitEleven) - parseFloat(netGACostDiv11) - parseFloat(divProfElevenOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((parseFloat(pretotalJobProfitEleven) - parseFloat(prenetGACostDiv11) - parseFloat(predivProfElevenOverhead)) ? (parseFloat(pretotalJobProfitEleven) - parseFloat(prenetGACostDiv11) - parseFloat(predivProfElevenOverhead)) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((IncomeOperDiv00 - (parseFloat(divDeferrCompOverhead) + parseFloat(divProfZeroOverhead) + parseFloat(divInvestCompOverhead))) ? (IncomeOperDiv00 - (parseFloat(divDeferrCompOverhead) + parseFloat(divProfZeroOverhead) + parseFloat(divInvestCompOverhead))) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((preIncomeOperDiv00 - (parseFloat(predivDeferrCompOverhead) + parseFloat(predivProfZeroOverhead) + parseFloat(predivInvestCompOverhead))) ? (preIncomeOperDiv00 - (parseFloat(predivDeferrCompOverhead) + parseFloat(predivProfZeroOverhead) + parseFloat(predivInvestCompOverhead))) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round(Math.round(((Math.round(expectedProfit1) + Math.round(expectedProfitABNC1) + Math.round(expectedProfitFA1) + Math.round(expectedProfit2) + Math.round(expectedProfitABNC2) + Math.round(expectedProfitFA2) + Math.round(expectedProfit3) + Math.round(expectedProfitABNC3) + Math.round(expectedProfitFA3) + Math.round(expectedProfit4) + Math.round(expectedProfitABNC4) + Math.round(expectedProfitFA4) + Math.round(expectedProfit5) + Math.round(expectedProfitABNC5) + Math.round(expectedProfitFA5) + Math.round(expectedProfit6) + Math.round(expectedProfitABNC6) + Math.round(expectedProfitFA6) + Math.round(expectedProfit7) + Math.round(expectedProfitABNC7) + Math.round(expectedProfitFA7) + Math.round(expectedProfit11) + Math.round(expectedProfitABNC11) + Math.round(expectedProfitFA11) + Math.round(expectedProfit00) + Math.round(expectedProfitABNC00) + Math.round(expectedProfitFA00)) + Math.round(ma_profit_1) + Math.round(ma_profit_2) + Math.round(ma_profit_3) + Math.round(ma_profit_4) + Math.round(ma_profit_5) + Math.round(ma_profit_6) + Math.round(ma_profit_7) + Math.round(ma_profit_11) + Math.round(ma_profit_00)) -  Math.round(netGAConsolidatedCost)) - otherIncomeTotal).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            <th style={{ textAlign: 'center'}}>{'$' + Math.round((((Math.round(preexpectedProfit1) + Math.round(preexpectedProfitABNC1) + Math.round(preexpectedProfitFA1) + Math.round(preexpectedProfit2) + Math.round(preexpectedProfitABNC2) + Math.round(preexpectedProfitFA2) + Math.round(preexpectedProfit3) + Math.round(preexpectedProfitABNC3) + Math.round(preexpectedProfitFA3) + Math.round(preexpectedProfit4) + Math.round(preexpectedProfitABNC4) + Math.round(preexpectedProfitFA4) + Math.round(preexpectedProfit5) + Math.round(preexpectedProfitABNC5) + Math.round(preexpectedProfitFA5) + Math.round(preexpectedProfit6) + Math.round(preexpectedProfitABNC6) + Math.round(preexpectedProfitFA6) + Math.round(preexpectedProfit7) + Math.round(preexpectedProfitABNC7) + Math.round(preexpectedProfitFA7) + Math.round(preexpectedProfit11) + Math.round(preexpectedProfitABNC11) + Math.round(preexpectedProfitFA11) + Math.round(preexpectedProfit00) + Math.round(preexpectedProfitABNC00) + Math.round(preexpectedProfitFA00)) + Math.round(prev_ma_profit_1) + Math.round(prev_ma_profit_2) + Math.round(prev_ma_profit_3) +  Math.round(prev_ma_profit_4) + Math.round(prev_ma_profit_5) + Math.round(prev_ma_profit_6) + Math.round(prev_ma_profit_7) + Math.round(prev_ma_profit_11) + Math.round(prev_ma_profit_00)) - Math.round(prenetGAConsolidatedCost)) - preotherIncomeTotal).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
        </tr>
  </>
}
      ...
      if(!loadedData) return <Container>Loading...</Container>
        ...
        <Navbar className="color-nav" style={{paddingBottom: '2%', paddingTop: '2%'}} expand="lg">
          ...
          <div>
            ...
            <h1 id='title'>For The Year Ending December 31, {currentYearLabel}</h1>
...
export default withAuth(DivIncomeYearOne);