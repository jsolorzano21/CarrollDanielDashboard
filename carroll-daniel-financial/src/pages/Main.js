...
class Main extends Component{
  ...
  renderTableData(value) {
    if(value === 'project_report'){
      ...
      if(division === '1'){
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue1_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit1_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC1_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC1_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA1_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA1_two += preprofitCurrentYear;
          }
        }
        ...
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue2_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit2_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC2_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC2_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA2_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA2_two += preprofitCurrentYear;
          }
        }
        ...
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue3_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit3_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC3_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC3_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA3_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA3_two += preprofitCurrentYear;
          }
        }
        ...
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue4_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit4_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC4_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC4_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA4_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA4_two += preprofitCurrentYear;
          }
        }
        ...
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue5_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit5_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC5_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC5_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA5_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA5_two += preprofitCurrentYear;
          }
        }
        ...
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue6_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit6_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC6_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC6_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA6_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA6_two += preprofitCurrentYear;
          }
        }
        ...
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue7_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit7_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC7_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC7_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA7_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA7_two += preprofitCurrentYear;
          }
        }
        ...
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue11_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit11_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC11_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC11_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA11_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA11_two += preprofitCurrentYear;
          }
        }
        ...
        if( status === 'Contract'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenue00_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfit00_two += preprofitCurrentYear;
          }
        }else if( status === 'ABNC'){
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueABNC00_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitABNC00_two += preprofitCurrentYear;
          }
        }else{
          if(parseInt(currentQuarterResp) === parseInt(quarter) && parseInt(currentYearResp) === parseInt(year)){
            ...
            preexpectedRevenueFA00_two += parseFloat(pretotalExpectedRevenue);
            preexpectedProfitFA00_two += preprofitCurrentYear;
          }
        }
      ...
      prejobProfitFATotal_two = parseFloat(preexpectedProfitFA1) + parseFloat(preexpectedProfitFA2) + parseFloat(preexpectedProfitFA3) + parseFloat(preexpectedProfitFA4) + parseFloat(preexpectedProfitFA5) + parseFloat(preexpectedProfitFA6) + parseFloat(preexpectedProfitFA7) + parseFloat(preexpectedProfitFA11)  + parseFloat(preexpectedProfitFA00);
   ...
   renderTableHeader(value) {
      ...
      return <>
            ...
            <th style={{ textAlign: 'center'}}>Current Contracts</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{'$' + (revenueTotal !== 0 ? Math.round(revenueTotal) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{'$' + (prerevenueTotal !== 0 ? Math.round(prerevenueTotal) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{'$' + (Math.round(revenueTotal) - Math.round(prerevenueTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{'$' + (revenueTotal_two !== 0 ? Math.round(revenueTotal_two) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{'$' + (prerevenueTotal_two !== 0 ? Math.round(prerevenueTotal_two) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{'$' + (Math.round(revenueTotal_two) - Math.round(prerevenueTotal_two)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Awarded But Not Contracted</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(revenueABNCTotal !== 0 ? Math.round(revenueABNCTotal) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(prerevenueABNCTotal !== 0 ? Math.round(prerevenueABNCTotal) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(revenueABNCTotal) - Math.round(prerevenueABNCTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(revenueABNCTotal_two !== 0 ? Math.round(revenueABNCTotal_two) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(prerevenueABNCTotal_two !== 0 ? Math.round(prerevenueABNCTotal_two) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(revenueABNCTotal_two) - Math.round(prerevenueABNCTotal_two)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>  
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Future Awards</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(revenueFATotal !== 0 ? Math.round(revenueFATotal) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(prerevenueFATotal !== 0 ? Math.round(prerevenueFATotal) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(revenueFATotal) - Math.round(prerevenueFATotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(revenueFATotal_two !== 0 ? Math.round(revenueFATotal_two) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(prerevenueFATotal_two !== 0 ? Math.round(prerevenueFATotal_two) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(revenueFATotal_two) - Math.round(prerevenueFATotal_two)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Management Adjustment</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(ma_revenue_1 + ma_revenue_2 + ma_revenue_3 + ma_revenue_4 + ma_revenue_5 + ma_revenue_6 + ma_revenue_7 + ma_revenue_11 + ma_revenue_00).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prev_ma_revenue_1 + prev_ma_revenue_2 + prev_ma_revenue_3 + prev_ma_revenue_4 + prev_ma_revenue_5 + prev_ma_revenue_6 + prev_ma_revenue_7 + prev_ma_revenue_11 + prev_ma_revenue_00).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(ma_revenue_1 + ma_revenue_2 + ma_revenue_3 + ma_revenue_4 + ma_revenue_5 + ma_revenue_6 + ma_revenue_7 + ma_revenue_11 + ma_revenue_00)) - (Math.round(prev_ma_revenue_1 + prev_ma_revenue_2 + prev_ma_revenue_3 + prev_ma_revenue_4 + prev_ma_revenue_5 + prev_ma_revenue_6 + prev_ma_revenue_7 + prev_ma_revenue_11 + prev_ma_revenue_00))}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(ma_revenue_1_two + ma_revenue_2_two + ma_revenue_3_two + ma_revenue_4_two + ma_revenue_5_two + ma_revenue_6_two + ma_revenue_7_two + ma_revenue_11_two + ma_revenue_00_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prev_ma_revenue_1_two + prev_ma_revenue_2_two + prev_ma_revenue_3_two + prev_ma_revenue_4_two + prev_ma_revenue_5_two + prev_ma_revenue_6_two + prev_ma_revenue_7_two + prev_ma_revenue_11_two + prev_ma_revenue_00_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(ma_revenue_1_two + ma_revenue_2_two + ma_revenue_3_two + ma_revenue_4_two + ma_revenue_5_two + ma_revenue_6_two + ma_revenue_7_two + ma_revenue_11_two + ma_revenue_00_two)) - (Math.round(prev_ma_revenue_1_two + prev_ma_revenue_2_two + prev_ma_revenue_3_two + prev_ma_revenue_4_two + prev_ma_revenue_5_two + prev_ma_revenue_6_two + prev_ma_revenue_7_two + prev_ma_revenue_11_two + prev_ma_revenue_00_two))}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Total</th>
                <th style={{ textAlign: 'center'}}>{Math.round(Math.round(revenueTotal) + Math.round(revenueABNCTotal) + Math.round(revenueFATotal) + ma_revenue_1 + ma_revenue_2 + ma_revenue_3 + ma_revenue_4 + ma_revenue_5 + ma_revenue_6 + ma_revenue_7 + ma_revenue_11 + ma_revenue_00).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
        ...
        return <>
            ...
            <tr>
            <th style={{ textAlign: 'center'}}>Current Contracts</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(jobProfitTotal).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prejobProfitTotal).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(jobProfitTotal) - Math.round(prejobProfitTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(jobProfitTotal_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prejobProfitTotal_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(jobProfitTotal_two) - Math.round(prejobProfitTotal_two)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Awarded But Not Contracted</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(jobProfitABNCTotal).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prejobProfitABNCTotal).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(jobProfitABNCTotal) - Math.round(prejobProfitABNCTotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(jobProfitABNCTotal_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prejobProfitABNCTotal_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(jobProfitABNCTotal_two) + Math.round(prejobProfitABNCTotal_two)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Future Awards</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(jobProfitFATotal).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prejobProfitFATotal).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(jobProfitFATotal) - Math.round(prejobProfitFATotal)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(jobProfitFATotal_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prejobProfitFATotal_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(jobProfitFATotal_two) - Math.round(prejobProfitFATotal_two)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Management Adjustment</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(ma_profit_1 + ma_profit_2 + ma_profit_3 + ma_profit_4 + ma_profit_5 + ma_profit_6 + ma_profit_7 + ma_profit_11 + ma_profit_00).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prev_ma_profit_1 + prev_ma_profit_2 + prev_ma_profit_3 + prev_ma_profit_4 + prev_ma_profit_5 + prev_ma_profit_6 + prev_ma_profit_7 + prev_ma_profit_11 + prev_ma_profit_00).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(ma_profit_1_two + ma_profit_2_two + ma_profit_3_two + ma_profit_4_two + ma_profit_5_two + ma_profit_6_two + ma_profit_7_two + ma_profit_11_two + ma_profit_00_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prev_ma_profit_1_two + prev_ma_profit_2_two + prev_ma_profit_3_two + prev_ma_profit_4_two + prev_ma_profit_5_two + prev_ma_profit_6_two + prev_ma_profit_7_two + prev_ma_profit_11_two + prev_ma_profit_00_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            ...
            <th style={{ textAlign: 'center'}}>Total</th>
                ...
                <th style={{ textAlign: 'center'}}>{Math.round((jobProfitFinalTotal_two) + ma_profit_1_two + ma_profit_2_two + ma_profit_3_two + ma_profit_4_two + ma_profit_5_two + ma_profit_6_two + ma_profit_7_two + ma_profit_11_two + ma_profit_00_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                ...
                <th style={{ textAlign: 'center'}}>{Math.round((prevJobProfitFinalTotal_two) + prev_ma_profit_1_two + prev_ma_profit_2_two + prev_ma_profit_3_two + prev_ma_profit_4_two + prev_ma_profit_5_two + prev_ma_profit_6_two + prev_ma_profit_7_two + prev_ma_profit_11_two + prev_ma_profit_00_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center'}}>{((Math.round(jobProfitTotal_two) - Math.round(prejobProfitTotal_two)) + (Math.round(jobProfitABNCTotal_two) + Math.round(prejobProfitABNCTotal_two)) + (Math.round(jobProfitFATotal_two) - Math.round(prejobProfitFATotal_two)) + (Math.round(ma_profit_1_two + ma_profit_2_two + ma_profit_3_two + ma_profit_4_two + ma_profit_5_two + ma_profit_6_two + ma_profit_7_two + ma_profit_11_two + ma_profit_00_two) - Math.round(prev_ma_profit_1_two + prev_ma_profit_2_two + prev_ma_profit_3_two + prev_ma_profit_4_two + prev_ma_profit_5_two + prev_ma_profit_6_two + prev_ma_profit_7_two + prev_ma_profit_11_two + prev_ma_profit_00_two))).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            </tr>
        </>
      ...
      return <>
            ...
            <th style={{ textAlign: 'center'}}>Total G & A Cost</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((Math.round((divZeroOverhead + divRangeOverhead + divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead))) - Math.round((predivZeroOverhead + predivRangeOverhead + predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead))).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                ...
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((((predivZeroOverhead_two)*1.03) + ((predivRangeOverhead_two)*1.03) + ((predivOneOverhead_two)*1.03) + ((predivTwoOverhead_two)*1.03) + ((predivThreeOverhead_two)*1.03) + ((predivFourOverhead_two)*1.03) + ((predivFiveOverhead_two)*1.03) + ((predivSixOverhead_two)*1.03) + ((predivSevenOverhead_two)*1.03) + ((predivElevenOverhead_two)*1.03))).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            ...
            <th style={{ textAlign: 'center'}}>Direct Overhead Expenses</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead))}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead))}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(((divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead) - (divOneOverhead + divTwoOverhead + divThreeOverhead + divFourOverhead + divFiveOverhead + divSixOverhead + divSevenOverhead + divElevenOverhead)) - ((predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead) - (predivOneOverhead + predivTwoOverhead + predivThreeOverhead + predivFourOverhead + predivFiveOverhead + predivSixOverhead + predivSevenOverhead + predivElevenOverhead))).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((divOneOverhead_two*1.03 + divTwoOverhead_two*1.03 + divThreeOverhead_two*1.03 + divFourOverhead_two*1.03 + divFiveOverhead_two*1.03 + divSixOverhead_two*1.03 + divSevenOverhead_two*1.03 + divElevenOverhead_two*1.03) - (divOneOverhead_two*1.03 + divTwoOverhead_two*1.03 + divThreeOverhead_two*1.03 + divFourOverhead_two*1.03 + divFiveOverhead_two*1.03 + divSixOverhead_two*1.03 + divSevenOverhead_two*1.03 + divElevenOverhead_two*1.03))}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((predivOneOverhead_two*1.03 + predivTwoOverhead_two*1.03 + predivThreeOverhead_two*1.03 + predivFourOverhead_two*1.03 + predivFiveOverhead_two*1.03 + predivSixOverhead_two*1.03 + predivSevenOverhead_two*1.03 + predivElevenOverhead_two*1.03) - (predivOneOverhead_two*1.03 + predivTwoOverhead_two*1.03 + predivThreeOverhead_two*1.03 + predivFourOverhead_two*1.03 + predivFiveOverhead_two*1.03 + predivSixOverhead_two*1.03 + predivSevenOverhead_two*1.03 + predivElevenOverhead_two*1.03))}</th>
            ...
            <th style={{ textAlign: 'center'}}>50% of Rev. Allocation</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((fiftyPerRev - fiftyPerRev) ? (fiftyPerRev - fiftyPerRev) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((prefiftyPerRev - prefiftyPerRev) ? (prefiftyPerRev - prefiftyPerRev) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((prefiftyPerRev - prefiftyPerRev) ? ((fiftyPerRev - fiftyPerRev) - (prefiftyPerRev - prefiftyPerRev)) : 0)}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((fiftyPerRev_two - fiftyPerRev_two) ? (fiftyPerRev_two - fiftyPerRev_two) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((prefiftyPerRev_two - prefiftyPerRev_two) ? (prefiftyPerRev_two - prefiftyPerRev_two) : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((prefiftyPerRev_two - prefiftyPerRev_two) ? ((fiftyPerRev_two - fiftyPerRev_two) - (prefiftyPerRev_two - prefiftyPerRev_two)) : 0)}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>50% of GM Allocation</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(netCostConsolidated ? netCostConsolidated : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(prenetCostConsolidated ? prenetCostConsolidated : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((netCostConsolidated ? (netCostConsolidated - prenetCostConsolidated) : 0)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(netCostConsolidated_two ? netCostConsolidated_two : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(prenetCostConsolidated_two ? prenetCostConsolidated_two : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((netCostConsolidated_two ? (netCostConsolidated_two - prenetCostConsolidated_two) : 0)).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Net G & A Cost</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(netGAConsolidatedCost ? netGAConsolidatedCost : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prenetGAConsolidatedCost ? prenetGAConsolidatedCost : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((netGAConsolidatedCost ? netGAConsolidatedCost : 0) - prenetGAConsolidatedCost).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(netGAConsolidatedCost_two ? netGAConsolidatedCost_two : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(prenetGAConsolidatedCost_two ? prenetGAConsolidatedCost_two : 0).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(netGAConsolidatedCost_two - prenetGAConsolidatedCost_two).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>% Rev</th>
         ...
         <tr>
            ...
            <th style={{ textAlign: 'center'}}>Deferred Compensation</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(divDeferrCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(predivDeferrCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((divDeferrCompOverhead) - (predivDeferrCompOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(divDeferrCompOverhead_two*1.03).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(predivDeferrCompOverhead_two*1.03).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((divDeferrCompOverhead_two*1.03) - (predivDeferrCompOverhead_two*1.03)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Profit Sharing</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(divProfOneOverhead + divProfTwoOverhead + divProfThreeOverhead + divProfFourOverhead + divProfFiveOverhead + divProfSixOverhead + divProfSevenOverhead + divProfElevenOverhead + divProfZeroOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(predivProfOneOverhead + predivProfTwoOverhead + predivProfThreeOverhead + predivProfFourOverhead + predivProfFiveOverhead + predivProfSixOverhead + predivProfSevenOverhead + predivProfElevenOverhead + predivProfZeroOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((Math.round(divProfOneOverhead + divProfTwoOverhead + divProfThreeOverhead + divProfFourOverhead + divProfFiveOverhead + divProfSixOverhead + divProfSevenOverhead + divProfElevenOverhead + divProfZeroOverhead)) - (Math.round(predivProfOneOverhead + predivProfTwoOverhead + predivProfThreeOverhead + predivProfFourOverhead + predivProfFiveOverhead + predivProfSixOverhead + predivProfSevenOverhead + predivProfElevenOverhead + predivProfZeroOverhead))).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(divProfOneOverhead_two*1.03 + divProfTwoOverhead_two*1.03 + divProfThreeOverhead_two*1.03 + divProfFourOverhead_two*1.03 + divProfFiveOverhead_two*1.03 + divProfSixOverhead_two*1.03 + divProfSevenOverhead_two*1.03 + divProfElevenOverhead_two*1.03 + divProfZeroOverhead_two*1.03).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(predivProfOneOverhead_two*1.03 + predivProfTwoOverhead_two*1.03 + predivProfThreeOverhead_two*1.03 + predivProfFourOverhead_two*1.03 + predivProfFiveOverhead_two*1.03 + predivProfSixOverhead_two*1.03 + predivProfSevenOverhead_two*1.03 + predivProfElevenOverhead_two*1.03 + predivProfZeroOverhead_two*1.03).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
            ...
            <th style={{ textAlign: 'center'}}>Investment Income</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(divInvestCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(predivInvestCompOverhead).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round((divInvestCompOverhead) - (predivInvestCompOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(divInvestCompOverhead_two*1.03).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(predivInvestCompOverhead_two*1.03).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{((divInvestCompOverhead_two*1.03) - (predivInvestCompOverhead_two*1.03)).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
            </tr>
            <tr>
            <th style={{ textAlign: 'center'}}>Other Income</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(divDeferrCompOverhead) + Math.round(divProfOneOverhead + divProfTwoOverhead + divProfThreeOverhead + divProfFourOverhead + divProfFiveOverhead + divProfSixOverhead + divProfSevenOverhead + divProfElevenOverhead + divProfZeroOverhead) + Math.round(divInvestCompOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(Math.round(predivDeferrCompOverhead) + Math.round(predivProfOneOverhead + predivProfTwoOverhead + predivProfThreeOverhead + predivProfFourOverhead + predivProfFiveOverhead + predivProfSixOverhead + predivProfSevenOverhead + predivProfElevenOverhead + predivProfZeroOverhead) + Math.round(predivInvestCompOverhead)).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{Math.round(Math.round((divDeferrCompOverhead) - (predivDeferrCompOverhead)) + ((Math.round(divProfOneOverhead + divProfTwoOverhead + divProfThreeOverhead + divProfFourOverhead + divProfFiveOverhead + divProfSixOverhead + divProfSevenOverhead + divProfElevenOverhead + divProfZeroOverhead)) - (Math.round(predivProfOneOverhead + predivProfTwoOverhead + predivProfThreeOverhead + predivProfFourOverhead + predivProfFiveOverhead + predivProfSixOverhead + predivProfSevenOverhead + predivProfElevenOverhead + predivProfZeroOverhead))) + ((divInvestCompOverhead) - (predivInvestCompOverhead))).toLocaleString(undefined, {maximumFractionDigits:2})}</th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(divDeferrCompOverhead_two*1.03) + Math.round(divProfOneOverhead_two*1.03 + divProfTwoOverhead_two*1.03 + divProfThreeOverhead_two*1.03 + divProfFourOverhead_two*1.03 + divProfFiveOverhead_two*1.03 + divProfSixOverhead_two*1.03 + divProfSevenOverhead_two*1.03 + divProfElevenOverhead_two*1.03 + divProfZeroOverhead_two*1.03) + Math.round(divInvestCompOverhead_two*1.03)).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}></th>
                <th style={{ textAlign: 'center', fontWeight: 'normal'}}>{(Math.round(predivDeferrCompOverhead_two*1.03) + Math.round(predivProfOneOverhead_two*1.03 + predivProfTwoOverhead_two*1.03 + predivProfThreeOverhead_two*1.03 + predivProfFourOverhead_two*1.03 + predivProfFiveOverhead_two*1.03 + predivProfSixOverhead_two*1.03 + predivProfSevenOverhead_two*1.03 + predivProfElevenOverhead_two*1.03 + predivProfZeroOverhead_two*1.03) + Math.round(predivInvestCompOverhead_two*1.03)).toLocaleString(undefined, {maximumFractionDigits:2})}</th> 
